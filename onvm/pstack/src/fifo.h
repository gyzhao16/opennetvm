...
extern inline int insert(queue_t *q, ELEMENT_TYPE value);
extern inline int insert_hpq(queue_t *, ELEMENT_TYPE);
extern inline int extract_hpq(queue_t *, ELEMENT_TYPE *);
extern inline int extract(queue_t *q, ELEMENT_TYPE * value);
