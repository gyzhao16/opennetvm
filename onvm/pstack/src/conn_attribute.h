...
sig_type calc_signature(const uint32_t, const uint32_t, const uint16_t, const uint16_t);
int sig_match_e(const sig_type, const elem_type *);
int sig_match_l(const sig_type, const elem_list_type *);
idx_type index_e(const elem_type *);
idx_type index_l(const elem_list_type *);
idx_type get_cached_index(const void *, const int);
void store_cached_index(const void *, const int, const idx_type);
